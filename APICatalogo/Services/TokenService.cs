...
namespace APICatalogo.Services
{
    public class TokenService : ITokenService
    {
        ...
        {
            var key = _config.GetSection("JWT").GetValue<string>("SecretKey") ?? throw new ArgumentNullException("Invalid Secret Key!!");
        ...
        {
            var secretKey = _config.GetSection("JWT").GetValue<string>("SecretKey") ?? throw new ArgumentNullException("Invalid Secret Key!!");
